# Start All Servers for Skip On App
# This starts both the FastAPI backend and the Engage server

Write-Host "🚀 Starting All Servers for Skip On..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "Next: Start frontend with 'cd frontend && npm start'" -ForegroundColor Cyan
